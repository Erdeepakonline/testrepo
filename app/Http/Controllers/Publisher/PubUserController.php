...
class PubUserController extends Controller
{
    ...
    */
    ...
    {
      $user = User::select('phonecode','first_name', 'last_name', 'email', 'phone', 'address_line1', 'address_line2', 'city', 'state', 'country', 'pub_wallet', 'profile_lock','messenger_name','messenger_type','del_request','user_type')
        ->where('uid', $uid)->first();
          ...
          if ($user->update()) {
            ...
            /* Adunit Activity Add & Generate Notification */
                ...
                $useridas = $user->uid;
              	...
              	$subject = 'KYC Update Request Accepted successfully - 7Search PPC';
                ...
                $subjectadmin = 'KYC Update Request Accepted successfully - Publisher 7Search PPC';
