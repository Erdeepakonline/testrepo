     ...
     <tr>
       ...
       <td colspan="2">		 
           <table  style="width:100%; border-collapse: collapse;" border="0">
             <thead>
               <tr style="background-color: #d15555;color: #fff;font-weight: 600;text-align: left;">
             ...
             <tbody>
              ...
              <tr>
                <td colspan="2"></td>
                <td style="padding: 10px 15px;line-height: 1.55em;caption-side: bottom;border-collapse: collapse;border-top: 1px solid #dbdfea;color: #fff;font-weight: 700; background-color: #d15555;">Grand Total </td>
                <td style="padding: 10px 15px;line-height: 1.55em;caption-side: bottom;border-collapse: collapse;border-top: 1px solid #dbdfea;color: #fff;font-weight: 700; background-color: #d15555;">${{ $details['payble_amt'] }}</td>
              </tr>
