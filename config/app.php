...
return [
    ...
    */
    ...
    'add_impression_new' => env('ADD_IMPRESSION_NEW', 0),
    'add_script_new' => env('AD_SCRIPT_NEW', 0),

    'swagger_username' => env('BASIC_AUTH_USERNAME'),
    'swagger_password' => env('BASIC_AUTH_PASSWORD'),
