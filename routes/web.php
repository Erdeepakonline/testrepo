...
use App\Http\Controllers\Payment\AppPaymentRazorpayController;
...
use Illuminate\Support\Facades\Storage;
  ...
  */   
  ...
  /* ################################ Payment GetWays Section ####################### */
      ...
      Route::get('app_stripe_success/{data}',[PaymentStripeController::class,'stripe_response']);
   ...
   // Route::post('user/payment/upscreenshot',[PaymentCoinQrController::class,'upload_screen']);
    ...
    Route::any('payment/bitcoin/online/response',[PaymentCoinOnlineController::class,'bitcoin_response']);
     ...
     Route::any('app_payment_bitcoin_online_failed_response',[AppPaymentCoinOnlineController::class,'bitcoin_app_response']);
